...
struct LibraryPage : View {
    ...
    var songs: [String:String] = ["penthouse":"Me" , "Anadolu_Rock":"My Self","cemKaraca":"I","Türkce_90lar":"Still Me"]
    @State var CategoryIndex : Int
    @State var subCategorys = ["Playlists", "Albums", "Artists", "Podcasts and Shows"]
        ...
        ZStack{
            ...
            Text("Your Library")
                ...
                .onTapGesture {
                    page = "music"
                    withAnimation(.easeIn,{
                        subCategorys = ["Playlists", "Albums", "Artists", "Podcasts & Shows",]
