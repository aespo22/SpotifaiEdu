...
struct SearchPage: View {
    ...
    let categories = ["Podcast":"Trap","Raggaetton":"O Gas ","Commercial":"Hip Hop","NeoMelodic":"Chill","Fitness":"Romantic","Disco":"Canzon Napulitan" ]
    var body: some View {
        ZStack{
            ...
            VStack {
                ...
                VStack{
                    ...
                    Category(color1: .red,text1: "Radio Maria" ,color2: .green, text2: "O Gas")
                }
                    HStack{
                        Text("Browse all")
                            .foregroundColor(.white)
