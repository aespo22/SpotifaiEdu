...
struct ContentView: View {
    ...
    var songs: [String:String] = ["penthouse":"Me" , "Anadolu_Rock":"My Self","cemKaraca":"Still Me","Türkce_90lar":"I"]
                ...
                VStack{
                    ...
                    HStack{
                        ...
                        Image(systemName: "")
                            ...
                            .padding(.trailing , 30).padding(.top , 80)
                    }
                    HStack{
                       
                      
                        Text("Good afternoon").font(.title).foregroundColor(.white).bold()
